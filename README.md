...
<p align="center">Please insure that you are cloning repository in ~, else it's not gonna work. Also DO NOT remove the ~/mqbg directory even after installation, as it's where the program files are kept</p>
